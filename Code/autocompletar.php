...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				...
				<li class="sub_show"><a href="autocompletar.php">adicionar Ordem</a></li>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			function peganome(id){
				$.post("funcionario.php",{idfunc:id},function(retorno){
					dados = retorno.split("/");
					$('#mat').val(dados[0]);
					$('#funcao').val(dados[1]);
				});
            ...
            Funcionario:
              <select name="funcionario" onChange="peganome(this.value)">
                <option value="">Escolha um funcionario</option>
                </br>
                <?php
                	$sql = mysql_query("SELECT id, nome FROM quadros");
                	while($func = mysql_fetch_object($sql)){
                        echo "
          ...
          <input type='text' name='Matricula' id='mat'></br>
            funcao:</br>
